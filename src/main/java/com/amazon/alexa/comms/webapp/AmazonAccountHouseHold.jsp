...
function show() {
	...
	var accountOne = document.forms["AmazonAccountHouseHoldForm"]["userOneEmail"].value;
    var passwordOne = document.forms["AmazonAccountHouseHoldForm"]["userOnePassword"].value;
    var accountTwo = document.forms["AmazonAccountHouseHoldForm"]["userOneEmail"].value;
    var passwordTwo = document.forms["AmazonAccountHouseHoldForm"]["userOnePassword"].value;

	  if (accountOne != "" && passwordOne != "" && accountTwo != "" && passwordTwo != "")
	  {
...
function validateForm() {
	  ...
	  if (accountOne == "") {
	    alert("Account One must be filled out");
	    return false;
	  }
	  if (passwordOne == "") {
		    alert("Password One must be filled out");
		    return false;
		  }
		  if (accountTwo == "") {
          	    alert("Account Two must be filled out");
          	    return false;
          	  }
          	  if (passwordTwo == "") {
...
<center>
<form name="AmazonAccountHouseHoldForm" onsubmit="return validateForm()" action = "addAmazonAccountsAsHouseHold" method = "post" >

Account One Email
<input class="form-control" type = "text" name = "userOneEmail" placeholder="Enter Account One Email..."></input>
Password
<input class="form-control" type = "text" name = "userOnePassword" placeholder="Password..."></input>
Account Two Email
<input class="form-control" type = "text" name = "userTwoEmail" placeholder="Enter Account Two Email..."></input>
Password
<input class="form-control" type = "text" name = "userTwoPassword" placeholder="Password..."></input>

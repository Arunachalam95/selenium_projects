...
function show() {
	...
	var Account = document.forms["AmazonAccountEffectiveMarketPlaceIdForm"]["email"].value;
	  	var Password = document.forms["AmazonAccountEffectiveMarketPlaceIdForm"]["password"].value;
...
<center>
<form name="AmazonAccountEffectiveMarketPlaceIdForm" onsubmit="return validateForm()" action = "getAmazonAccountEffectiveMarketPlaceId" method = "post" >
